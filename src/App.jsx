  ...
  return (
    <div className='app-container'>
      <header className='header-container'>
        ...
        <a className='onu-link' href="https://brasil.un.org/pt-br">ONU</a>
        <a className='pda-link' href="https://programadoresdoamanha.org/">PDA</a>
      </header>
      <Main/>
      <div className='cards-container'>
      {
          pollutionInfo.map(pollution => <Card key={pollution.id} title={pollution.type} message={pollution.description}/>)
        }
        
        {
          deforestationInfo.map(deforestationInfo => <Card key={deforestationInfo.ano} title={"Desmatamento"} message={deforestationInfo.informacao}/>)
        }
      </div>
    </div>
  )
